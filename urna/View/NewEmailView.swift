...
class NewEmailView: UIView {

    //MARK: - propeties
    
    let titleLabel = ViewsFactory.createLabel(text: "Email", fontName: "Avenir", fontsize: 25)
    let textLabel = ViewsFactory.createLabel(text: "Enter your new email", fontName: "Avenir", fontsize: 16)
